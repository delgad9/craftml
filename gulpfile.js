...
//     .pipe(gulp.dest('../craftml-cli/viewer/public/js'))
// }

gulp.task('br:editor', function(){
...
gulp.task('br:craftml', function(){

    function doBundle(){
      return bundler.bundle()
        .on('error', gutil.log.bind(gutil, 'Browserify Error'))
        .pipe(source('craftml.js'))
        // .pipe(gulp.dest('./viewer/public'))
        .pipe(gulp.dest('../craftml-cli/viewer/public/js'))
    }
