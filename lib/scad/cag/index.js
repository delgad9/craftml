...
CAG.fromPointsNoCheck = function(points) {
	var Vector2D = require('../csg/geometry/Vector2D')
	var sides = [];
...
CAG.rectangle = require('../csg/shapes/rectangle')
CAG.circle = require('../csg/shapes/circle')
CAG.roundedRectangle = require('../csg/shapes/roundedRectangle')
