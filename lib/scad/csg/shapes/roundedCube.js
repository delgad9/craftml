...
module.exports = function roundedCube(options) {
    ...
    innercuberadius = innercuberadius.minus(new G.Vector3D(roundradius));
    var result = cube({
        center: center,
    ...
    for (var level = 0; level < 2; level++) {
        ...
        if (level == 1) z = -z;
        var p1 = new G.Vector3D(innercuberadius.x, innercuberadius.y, z).plus(center);
        var p2 = new G.Vector3D(innercuberadius.x, -innercuberadius.y, z).plus(center);
        var p3 = new G.Vector3D(-innercuberadius.x, -innercuberadius.y, z).plus(center);
        var p4 = new G.Vector3D(-innercuberadius.x, innercuberadius.y, z).plus(center);
        var s = sphere({
            center: p1,
            radius: roundradius,
    ...
    result.properties.roundedCube.center = new G.Vertex(center);
    result.properties.roundedCube.facecenters = [
        new Connector(new G.Vector3D([cuberadius.x, 0, 0]).plus(center), [1, 0, 0], [0, 0, 1]),
        new Connector(new G.Vector3D([-cuberadius.x, 0, 0]).plus(center), [-1, 0, 0], [0, 0, 1]),
        new Connector(new G.Vector3D([0, cuberadius.y, 0]).plus(center), [0, 1, 0], [0, 0, 1]),
        new Connector(new G.Vector3D([0, -cuberadius.y, 0]).plus(center), [0, -1, 0], [0, 0, 1]),
        new Connector(new G.Vector3D([0, 0, cuberadius.z]).plus(center), [0, 0, 1], [1, 0, 0]),
        new Connector(new G.Vector3D([0, 0, -cuberadius.z]).plus(center), [0, 0, -1], [1, 0, 0])
    ];
    return result;
}
