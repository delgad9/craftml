...
Polygon.prototype = {
    ...
    extrude: function(offsetvector) {
        var fromPolygons = require('../csg/from/fromPolygons')
        var newpolygons = [];
     ...
     */
     // This implementation assumes the bottom and top polygons are of the same size
     ...
     * @param top Top polygon
     */
    _addWalls1: function(walls, bottom, top, bFlipped) {
        ...
        console.log('bMoreTops', bMoreTops, 'bMoreBottoms', bMoreBottoms)
