...
Line3D = function(point, direction) {
...
Line3D.fromPlanes = function(p1, p2) {
    ...
    if ((mabsx >= mabsy) && (mabsx >= mabsz)) {
        ...
        var r = solve2Linear(p1.normal.y, p1.normal.z, p2.normal.y, p2.normal.z, p1.w, p2.w);
        origin = new Vector3D(0, r[0], r[1]);
    } else if ((mabsy >= mabsx) && (mabsy >= mabsz)) {
        // find a point p for which y is zero:
        var r = solve2Linear(p1.normal.x, p1.normal.z, p2.normal.x, p2.normal.z, p1.w, p2.w);
        origin = new Vector3D(r[0], 0, r[1]);
    } else {
        // find a point p for which z is zero:
        var r = solve2Linear(p1.normal.x, p1.normal.y, p2.normal.x, p2.normal.y, p1.w, p2.w);
