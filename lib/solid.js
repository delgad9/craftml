...
Solid.prototype.layoutEval = function(code){
    ...
    var alignX = function(v){
        align(this.children, 'x', v)
    }.bind(this)

    var alignY = function(v){
        align(this.children, 'y', v)
    }.bind(this)

    var alignZ = function(v){
        align(this.children, 'z', v)
    }.bind(this)
