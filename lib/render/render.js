        ...
        return  Promise
            ...
            .then(function(solids){
                ...
                _.forEach(solids, s => {
                    ...
                    // why _.defaults?
                    //
                    // this code is evaluated in post-order, the style
                    // of the children elements would have already been
                    // assigned to s
                    //
                    // we don't want the properties in element.style
                    // to override what are already there in s.style
                    //
