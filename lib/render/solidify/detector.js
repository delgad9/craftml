...
function computeDistance(poly1, poly2){
    return poly1.vertices[0].pos.distanceTo(poly2.vertices[0].pos)
}
...
export default class Detector{
    ...
    isTorus(){
        ...
        let distanceFirstLast = computeDistance(_.first(this.polygons), _.last(this.polygons))
        let distanceFirstSecond = computeDistance(_.first(this.polygons), _.get(this.polygons,1))
