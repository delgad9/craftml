...
export default function render_repeat(element, scope) {

    scope.solid.role = 'merge'

    if ('n' in element.attribs) {

        return repeat_n(element, scope)

    } else if ('each' in element.attribs && 'in' in element.attribs) {

        return repeat_each(element, scope)

    }
}

function repeat_n(element, scope){
...
function repeat_each(element, scope){
