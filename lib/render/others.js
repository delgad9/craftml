...
function align(solids, dim, v, grouped){
    ...
    solids.slice(1).forEach(function(solid) {
        ...
        // console.log('translateTo>>', newLoc, grouped)
        // solid.translateTo(newLoc.x, newLoc.y, newLoc.z, grouped)//false)//grouped)
    })
}
    ...
    return render(toRender, childScope)
        .then(function(solids) {
            ...
            solids.forEach(function(solid) {
                ...
                // solid.translateTo(new Location(newloc.x,newloc.y,newloc.z))
            })
