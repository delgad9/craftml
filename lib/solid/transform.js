...
export function resize(newSize) {
    ...
    // var savedLoc = _.clone(this.position)
...
//         }
//
//         console.log('  c', c.element.name, 'p:', c.position, 's:', c.size)
//         c.layout.transform(solid.m)
//         console.log('  c0', c.element.name, 'p:', c.position, 's:', c.size)
//
//         _.forEach(['x','y','z'], dim => {
//
...
//
//             let c1 = c.position[dim]
//             let c2 = c.position[dim] + c.size[dim]
//
//             c.position[dim] = Math.max(c1,s1)
//             c.size[dim] = Math.min(c2,s2) - c.position[dim]
//         })
//
//         console.log('  c1', c.element.name, 'p:', c.position, 's:', c.size)
//
//         if (c.role != 'define'){
//             //console.log('  c', c.element.name, 'p:', c.position, 's:', c.size)
//             c.layout.transformTo(c.position, c.size)
