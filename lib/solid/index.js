...
export default class Solid {
    ...
    add(obj){
        ...
        if (obj.polygons){
            ...
            this.element.children.push(solid.element)
            // auto translate to (0,0)
            solid.translateTo(0,0,0)

            //console.log('selectable!!:', CSSselect.is(solid.element,'*'))
        ...
        // solid.style = solid.parent.style
    }
    ...
    computeStyle(css){
        ...
        function setProperty(decl){
            ...
            if (decl.value == 'inherit' && parent){
                ...
                computedStyle[decl.property] = parent.style[decl.property]
