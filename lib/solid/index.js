    ...
    fitToChildren(recursive = false) {
        ...
        if (this.children) {
            ...
            if (this.layout.c){
                ...
                this.layout.transformTo(this.layout.location, s)
                this.box.transformTo(this.layout.location, s)

            } else {

                this.layout = new Box(new Location(0,0,0), s)
                this.box = new Box(new Location(0,0,0), s)
