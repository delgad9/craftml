...
Solid.fromGroup = function(solids){
    var grp = new Solid()
...
Solid.prototype.find = function(selector){
...
function _parse_arguments_to_location(args){
    var loc
    if (args.length >= 3){
...
Solid.prototype.mirrorX = _.partial(mirror,'x')
Solid.prototype.mirrorY = _.partial(mirror,'y')
Solid.prototype.mirrorZ = _.partial(mirror,'z')
...
Solid.prototype.layoutEval = require('./layout')
